...
<div>
    ...
    @endif
    <div class="bg-indigo-600 px-8 pt-10 lg:pt-14 pb-16 flex just">
        <!-- title -->
        <h1 class="text-xl
        text-white">WareTrack - Warehouse</h1>
        {{-- {{ session('success') ?? 'No success message' }} --}}
    </div>
    <div class="card shadow -mt-12 mx-6">
        <div class="card-body">
            ...
            <div class="relative overflow-x-auto">
                <table class="text-left w-full whitespace-nowrap" id="table">
                            ...
                            <tr class="border-gray-300 border-b">
                                ...
                                <td class="py-3 px-6 text-left">
                                    <button type="button" wire:click="openModal('edit',{{ $data->id }})"
                                     ...
                                     <a href="{{ route('warehouse-detail', $data->id) }}"
